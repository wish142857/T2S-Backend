...
def calculate_match_degree_t2r(t: Teacher, r: Recruitment) -> int:
    return difflib.SequenceMatcher(None, t.research_fields, r.research_fields).quick_ratio() * 1000
...
def calculate_match_degree_s2r(s: Student, r: Recruitment) -> int:
    ...
    return ((ratio_1 + ratio_2) / 2) * 1000


# 计算匹配度  导师研究方向-申请意向兴趣方向
def calculate_match_degree_t2a(t: Teacher, a: Application) -> int:
    return difflib.SequenceMatcher(None, t.research_fields, a.research_interests).quick_ratio() * 1000


# 计算匹配度  学生研究兴趣-申请意向兴趣方向
def calculate_match_degree_s2a(s: Student, a: Application) -> int:
    return difflib.SequenceMatcher(None, s.research_interest, a.research_interests).quick_ratio() * 1000
