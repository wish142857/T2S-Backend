...
class Message(models.Model):
    ...
    sender_teacher = models.ForeignKey(Teacher, on_delete=models.CASCADE, related_name='s_messages')    # 发送老师
    sender_student = models.ForeignKey(Student, on_delete=models.CASCADE, related_name='s_messages')    # 发送学生
    receiver_teacher = models.ForeignKey(Teacher, on_delete=models.CASCADE, related_name='r_messages')  # 接收老师
    receiver_student = models.ForeignKey(Student, on_delete=models.CASCADE, related_name='r_messages')  # 接收学生
